...
from .assignment import KAISAAssignment
from .base_preconditioner import BaseKFACPreconditioner
from .distributed import get_rank
from .distributed import get_world_size
from .distributed import TorchDistributedCommunicator
from .enums import AllreduceMethod
from .enums import AssignmentStrategy
from .enums import ComputeMethod
from .enums import DistributedStrategy
from .layers.base import KFACBaseLayer
from .layers.eigen import KFACEigenLayer
from .layers.inverse import KFACInverseLayer
from .layers.register import register_modules
...
class KFACPreconditioner(BaseKFACPreconditioner):
    ...
    Example:
        ...
        >>> preconditioner = .preconditioner.KFACPreconditioner(model, ...)
        >>>
