...
import optimizers.mkor
import optimizers.eva
...
def get_optimizer(
    ...
    if args.optimizer == 'mkor':
        optimizer = optimizers.mkor.MKOROptimizer(
            model=model,
            lr=args.base_lr,
            momentum=args.momentum,
            weight_decay=args.weight_decay,
        )
    elif args.optimizer == 'eva':
    ...
    if use_kfac and not (args.optimizer in ["mkor", "eva", "sgd"]):
